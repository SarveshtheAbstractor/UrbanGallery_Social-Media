...
@media only screen and (min-width: 1201px) {
 ...
 <div class="image_area">
              ...
              $query = "SELECT * FROM Profile WHERE userid=".$userdata['id']." ORDER BY id DESC LIMIT 1";
     ...
     <?php  echo   '<a href="?usernameup='.$_GET['user'].'" style="text-decoration: none; color:white">'; ?>
